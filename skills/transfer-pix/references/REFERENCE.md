# Kobana Transfer - Complete Reference

Complete documentation for managing Pix transfers, batches, and financial accounts. Covers both MCP tools and REST API.
...
### All Available MCP Tools (18 tools)
...
#### get_transfer_pix / cancel_transfer_pix
...
{
  "status": 422,
  "errors": [{"code": "validation_error", "param": "amount", "detail": "Amount must be greater than 0"}]
}
```
